...
Usage:
    python tools/diagnostics/test_imsdk_group_message.py <account_name> [group_id] [text]

Example:
    .\.venv\Scripts\python.exe tools\diagnostics\test_imsdk_group_message.py 齐天大圣 207191791 "小单 1"
    .\.venv\Scripts\python.exe tools\diagnostics\test_imsdk_group_message.py x1DuArYgV 207191791 "大 100"
"""
...
def main() -> int:
    if len(sys.argv) < 2:
        print("Usage: python tools/diagnostics/test_imsdk_group_message.py <account_name> [group_id] [text]")
        print()
        print("Examples:")
        print("  .\\.venv\\Scripts\\python.exe tools\\diagnostics\\test_imsdk_group_message.py 齐天大圣 207191791 \"小单 1\"")
        print("  .\\.venv\\Scripts\\python.exe tools\\diagnostics\\test_imsdk_group_message.py x1DuArYgV 207191791 \"大 100\"")
        return 2

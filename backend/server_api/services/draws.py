...
def analyze(site: str, rows: list[DrawResult], history_count: int, confidence_threshold: int) -> dict[str, object]:
    ...
    return {
        "site": site, "sample_count": sample_count, "number_sample_count": len(totals),
